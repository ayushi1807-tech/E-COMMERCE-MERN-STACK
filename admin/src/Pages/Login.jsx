    ...
    <>
      <div className="w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start">
        ...
        <div className="w-[90%] h-[100px] flex items-center justify-center flex-col gap-[10px]">
          <span className="text-[25px] font-semiboldt">Login Page</span>
          <span className="text-[16px]  text-gray-300">
            {" "}
            Welcome to ModaVibe,Apply to Admin Login!
          </span>
        </div>
        <div className="max-w-[600px] w-[90%] h-[400px] bg-[#00000025] border-[1px] border-[#96969696] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center">
          <form 
