...
function ProductDetails() {
  ...
  return productData ? (
    <div>
      <div className='w-[99vw] h-[130vh] 
      md:h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex 
      items-center justify-start flex-col lg:flex-row gap:flex-row gap-[20px]'>
        ...
        h-[50vh] mt-[70px] flex items-center justify-center
         md:gap-[10px] gap-[30px] flex-col-reverse lg:flex-row'>
          <div className='lg:w-[20%] md:w-[80%] h-[10%] 
          lg:h-[80%] flex items-center justify-center gap-[50px] 
          ...
          h-[70%] border-[1px] border-[#80808049] rounded-md overflow-hidden'>
                <img src={image} alt="" className='w-[100%] lg:h-[100%] h-[100%] text-[30px]
                 text-white text-center rounded-md object-fill'/>
          </div>
         </div>
         <div className='lg:w-[50vw] w-[100vw] lg:h-[75vh]  
         h-[40vh] lg:mt-[80px] flex items-start justify-start 
         flex-col py-[10px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] 
         lg:py-[0px] gap-[10px]'>
             <h1 className='text-[40px]  font-semibold text-[aliceblue] '>{productData.name.toUpperCase()}</h1>
              ...
              <div className='flex flex-col gap-[10px] my-[10px]'>
                  ...
                  <div className='flex gap-2 flex-wrap'>
                    {
                      productData.sizes.map((item,index)=>(
                        <button key={index} className={`border py-2 px-4 bg-slate-300 
                          rounded-md
                  ...
                  <button className='text-[16px] active:bg-slate-500 
                    cursor-pointer bg-[#495b61c9] py-[10px] px-[20px] rounded-2xl 
                    mt-[10px] border-[1px] border-[#80808049] text-[white] 4
                    shadow-md shadow-black' onClick={()=>addToCart(productData._id,size)}>Add to Cart</button>
              </div>
          ...
          <div className='w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border
           ...
           lg:ml-[100px] ml-[20px]'>
                <p className='w-[95%] h-[90%] flex items-center justify-center'>
                  upgrade your wardrobe with this stylish slim-fit cotten shirt,
                  Available on ModaVibe Lorem ipsum, dolor sit amet consectetur 
                  adipisicing elit. Reiciendis nisi aspernatur ratione ullam cum 
                  deleniti repudiandae error quo in at. Reprehenderit minima labore 
                  perferendis, commodi nam eos quibusdam possimus dolor!
                </p>
          </div>
