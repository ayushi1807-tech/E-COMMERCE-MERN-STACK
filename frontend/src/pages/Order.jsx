...
function Order() {
  ...
  return (
    ...
    p-[20px] pb-[150px] overflow-hidden 
      ...
      <div className='w-[100%] h-[92%] flex flex-wrap gap-[20px]'>
            {
                orderData.map((item,index)=>(
                    <div key={index} className='w-[100%] h-[10%] border-t border-b'>
                        <div className='w-[100%] h-[80%] flex items-start flgap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative'>
                            ...
                            <div className='flex items-start justify-center flex-col gap-[5px]'>
                                ...
                                <div className='absolute md:right-[5%]  right-[1%] md:top-[40%] top-[70%]'>
                                    <button className='md:px-[15px] py-[3px] rounded-md bg-[#101919] text-[#f3f9fc] md:py-[7px]
                                    text-[12px] md:text-[16px] px-[5px] cursor-pointer active:bg-slate-500 '
